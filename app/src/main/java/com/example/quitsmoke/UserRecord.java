...
public class UserRecord {
    ...
    public UserRecord(int user_id, int num_cig_in_pkt, Double cost_of_pkt, int avg_daily_cig_use_curr,
    ...
    public UserRecord(int num_cig_in_pkt, Double cost_of_pkt, int avg_daily_cig_use_curr, int goal_daily_cig_redn, String target_dt, String end_dt)
    {
