...
public class UserEvent {
    ...
    public UserEvent() {    }
    public UserEvent(int event_period_id, int event_user_id, int event_location_id,
    ...
    public UserEvent(double event_latitude, double event_longitude, String event_date_time)
    {    this.event_latitude         = event_latitude;
        this.event_longitude        = event_longitude;
        this.event_date_time             = event_date_time;
    }
